...
class PhotoOrganizer {
  ...
  void _extractSinglePhotoStringsAndCreatePhotos() {
    // Function used to retrieve single Photo string from given string with all the photos,
    // send it to Photo.fromString() method to create a new Photo.
    // Then inserts newly created photo into photos list and calls a function
  ...
  void _addPhotoToCity(Photo photo) {
    ...
    // a new "city name" key with photo element as value.
